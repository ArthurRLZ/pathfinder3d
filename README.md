...
- Algoritmos de busca implementados: **BFS** e **A\***.
...
Essa interface foi pensada para facilitar a adição de novos algoritmos (DFS, Dijkstra, etc.) sem precisar reescrever a lógica de animação ou de coleta de métricas — só implementar `start()`/`step()` seguindo o mesmo contrato.
